-- Données d'exemple pour TSE Catalogue - Marché Ivoirien
-- Prix en Francs CFA - Données réalistes pour la Côte d'Ivoire
-- Version: 1.0
-- Date: 6 janvier 2025
...
SELECT 'Données d''exemple insérées avec succès - Prix en Francs CFA pour le marché ivoirien' as message;
